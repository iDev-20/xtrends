...
class AppImages {
  ...
  static SvgPicture svgTrendIconWithStar = SvgPicture.asset('assets/svgs/trend_icon_with_star.svg');
  static SvgPicture svgCircleQuestioMark = SvgPicture.asset('assets/svgs/circle_questionMark.svg');

  //bottom nav
  static SvgPicture svgUnselectedHomeIcon = SvgPicture.asset('assets/svgs/unselected_home_icon.svg');
  static SvgPicture svgSelectedHomeIcon = SvgPicture.asset('assets/svgs/selected_home_icon.svg');
}
